      ...
      <div className="max-w-5xl mx-auto">
        ...
        <section className="mb-20">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 md:p-12">
            <h2 className="text-2xl font-semibold mb-6 dark:text-gray-800">
              Our Story
            </h2>
        ...
        <section className="mb-20 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <span className="text-green-600 font-bold">✓</span>
                <span className="dark:text-gray-600">Actionable solutions</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-green-600 font-bold">✓</span>
                <span className="dark:text-gray-600">Preventive insights</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
              <h3 className="font-semibold mb-3 dark:text-gray-800">Clarity</h3>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300">
              <h3 className="font-semibold mb-3 dark:text-gray-800">
                Learning
              </h3>
              <p className="text-gray-600 text-sm leading-relaxed">
